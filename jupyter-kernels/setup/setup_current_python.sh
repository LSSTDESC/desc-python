...
export DESC_PYTHON_VER=current
...
export FIRECROWN_DIR=$CONDA_PREFIX/lib/$DESCPYTHONVER/site-packages

export DESC_PY_EXTRA_PACKAGES=/global/common/software/lsst/github/desc-python-prod/prod/extra
